...
const FestivalSpecials = () => {
  ...
  return (
    <section className="py-24 bg-[#FFFDF7] relative overflow-hidden">
      {/* Background accent */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#FFFDF7] to-[#FFF8F0] opacity-50 -z-10"></div>

      <div className="max-w-[1600px] mx-auto px-6 relative z-10">

        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6 border-b border-[#E6D5B8] pb-6">
          <div>
            <span className="text-xs font-medium uppercase tracking-[0.3em] text-[#8B2131] mb-4 block">Seasonal Delights</span>
        ...
        <div className="relative">
          {loading ? (
            ...
            <div className="text-center py-20 border border-[#E6D5B8]/20 p-8">
              <Gift className="w-12 h-12 text-[#E6D5B8] mx-auto mb-4" />
              <h3 className="text-xl font-serif text-[#2C1810] mb-2">No festival specials</h3>
              <p className="text-[#5D4037] font-light">Stay tuned for festive season treats.</p>
            </div>
          )}
        </div>
