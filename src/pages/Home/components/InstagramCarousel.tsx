      ...
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center bg-gradient-to-r from-pink-500 to-purple-600 text-white px-6 py-3 rounded-full text-sm font-semibold mb-6 font-raleway">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto font-raleway">
              See what our fitness community is sharing about their supplement journey
            </p>
          </div>
    ...
    <section className="py-16 bg-muted">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-10">
          <a 
            href="https://www.instagram.com/daretodiet.fit" 
            target="_blank" 
